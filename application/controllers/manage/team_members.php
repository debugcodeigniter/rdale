...
class Team_members extends CI_Controller {
	...
	public $tblName 		= 	"team_members";
	public $colPrefix	 	= 	"member_";
	public $pKey			=	"member_id";
	public $moduleName 		=	"Team Members";
	public $controller 		=	"team_members";
	public $per_page 		=	"15";
	public $tStatus 		=	"member_status";
	public $listView 		=	"tmembers";
	public $addEditView 	=	"addTMember";
	...
	public function index($sortby="member_order", $order="ASC", $status="-",$keywords="-", $pg_no="")
	{
		//PER_PAGE_START
		...
		$search 			= ($keywords!="-") ? array('cols'=>$this->colPrefix.'name, member_designation','value'=>urldecode($keywords)) : array();	
	...
	{	
		...
		$data = array(
			...
			$this->colPrefix.'designation' 		=>		htmlspecialchars($this->input->post($this->colPrefix.'designation')),
			$this->colPrefix.'desc' 			=>		$this->input->post($this->colPrefix.'desc'),
			$this->colPrefix.'caption' 			=>		htmlspecialchars($this->input->post($this->colPrefix.'caption')),
			$this->colPrefix.'facebook' 		=>		htmlspecialchars($this->input->post($this->colPrefix.'facebook')),
			$this->colPrefix.'twitter' 			=>		htmlspecialchars($this->input->post($this->colPrefix.'twitter')),
			$this->colPrefix.'google' 			=>		htmlspecialchars($this->input->post($this->colPrefix.'google')),
			$this->colPrefix.'linkedin' 		=>		htmlspecialchars($this->input->post($this->colPrefix.'linkedin')),
