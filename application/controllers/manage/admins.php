...
class Admins extends CI_Controller {
	...
	public function addRecord()
	{
		...
		'access_users'				=> 		"No",
		'access_destinations'		=> 		($this->input->post('access_destinations')=="Yes") ? "Yes" : "No",
		'access_vendors'			=> 		($this->input->post('access_vendors')=="Yes") ? "Yes" : "No",
		'access_inclusions'			=> 		($this->input->post('access_inclusions')=="Yes") ? "Yes" : "No",
		'access_packages'			=> 		($this->input->post('access_packages')=="Yes") ? "Yes" : "No",
		'access_galleries'		 	=>	 	($this->input->post('access_galleries')=="Yes") ? "Yes" : "No",
		'access_testimonials'		=>	 	($this->input->post('access_testimonials')=="Yes") ? "Yes" : "No",
		...
		'access_subscribers'	 	=>	 	($this->input->post('access_subscribers')=="Yes") ? "Yes" : "No",
		'access_bookings'		 	=>	 	($this->input->post('access_bookings')=="Yes") ? "Yes" : "No",
		);
	...
	public function editRecord($editID="")
	{
		...
		{
		$data['pwd'] = 	md5(trim($this->input->post('pwd',false)));
		}
