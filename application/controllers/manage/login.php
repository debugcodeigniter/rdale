...
public $controller = "login";
	...
	public function login($msg="")
	{
		...
		$data['logo'] = './assets/frontend/images/logo/'.$this->SqlModel->getSingleField('logo2','site_settings',array('id'=>1));
	...
	public function forgot($msg="")
	{
		...
		$data['logo'] = './assets/frontend/images/logo/'.$this->SqlModel->getSingleField('logo','site_settings',array('id'=>1));
	...
	public function forgotpwd(){
		...
		if(!empty($forgot))
		{
			...
			{
				$pwd = substr(base64_encode(md5(uniqid())),rand(0,4),8);
				...
				<body>
				Hello ".$forgot['full_name'].":<br/><br/>As requested, we're sending you a new password. Use the information below to sign in to your administration account:<br/><br/>CMS URL: <a href=\"".base_url('manage')."\" target=\"_blank\">".base_url('manage')."</a><br/>Username: ".$forgot['user_name']."<br/>New Password: ".$pwd."<br/><br/>Admin Team,</br>".PROJECT_TITLE.'</body></html>';
	...
	{
		$un = ($this->input->post('username') ? $this->input->post('username'): '');
