...
<li>Menu Manager</li>
<li class="active"><strong>Main Menu</strong></li>
</ol>
 ...
 <div class="row alertrow">
    ...
    <button class="close alertBox" data-dismiss="alert">x</button>
		<div class="alert alert-success"><strong>Success!</strong> Main Menu updated sucessfully.</div>
	</div>
</div>
   <?php  } if($alert=="error") { ?>
  <div class="row alertrow">
...
<div class="row" style="min-height:400px;">
 ...
 <form method="post" action="<?php echo base_url('manage/menu/save');?>">
