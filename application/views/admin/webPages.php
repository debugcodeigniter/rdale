...
<div class="row" style="min-height:400px;">
	<div class="col-md-12">
       ...
       <!-- <strong>Note:</strong> Click on  <i style="color:#000" class="entypo-folder font16"></i> to add articles. -->
      <br clear="all" />
        <hr />
		...
		<table id="table-page" class="table table-hover table-striped">
            ...
            <?php
              ...
              <tr id="page-<?php echo $c['page_id'];?>">
                  <td><?php if($c['page_id']>10) { ?><input name="records[]" autocomplete="off" class="cselect" value="<?php echo $c['page_id'];?>" type="checkbox" /> <?php } ?></td>
                 <td><?php echo $c['page_id'];?></td>
                  
                  
                  <td><a  href="<?php echo base_url('manage/pages/control/'.$parent_id.'/'.$c['page_id']);?>"><?php echo $c['page_name'];?></a></td>
                 <td><a <?php echo ($c['page_id']>10) ? 'class="changestatus""' : 'style="cursor:default"';?> href="javascript:void(0);" data-controller="<?php echo $this->controller;?>" id="statusID<?php echo $c[$this->pKey];?>"><?php echo $c[$this->tStatus];?></a></td>
                  ...
                  <!--<a class="icon-left font16" href="<?php echo base_url();?>manage/pages/index/<?php echo $c['page_id'];?>">
					...
					<i class="entypo-folder"></i></a> -->
                 
                     <a target="_blank" class="icon-left font16" href="<?php echo base_url(($c['page_id']>1) ?$c['page_uri'].'?preview=1' : '');?>">
