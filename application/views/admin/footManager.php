...
else if($foot_type=="two")
{	
	$fname = "Footer Menu Two";
}
else if($foot_type=="three")
{	$fname = "Company";
}
else{
	$fname = "";
...
<li class="active"><strong><?php echo $fname;?></strong></li>
</ol>
 ...
 <div class="row alertrow">
    ...
    <button class="close alertBox" data-dismiss="alert">x</button>
		<div class="alert alert-success"><strong>Success!</strong> <?php echo $fname;?> updated sucessfully.</div>
	</div>
</div>
   <?php  } if($alert=="error") { ?>
  <div class="row alertrow">
