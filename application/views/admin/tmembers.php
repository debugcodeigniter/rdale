		...
		<table id="table-<?php echo $this->controller;?>" class="table table-hover table-striped">
			<thead>
				<tr>
                    ...
                    <th class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'designation/'.'/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Designation</a></th>
              ...
              <tr id="<?php echo $this->controller.'-'.$c[$this->pKey];?>">
                 ...
                 <td >
                  ...
                  <td><a href="<?php echo base_url('manage/'.$this->controller.'/control/edit/'.$c[$this->pKey]);?>"><?php echo $c[$this->colPrefix.'name'];?></a></td>
                   <td class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/control/edit/'.$c[$this->pKey]);?>"><?php echo $c[$this->colPrefix.'designation'];?></a></td>
