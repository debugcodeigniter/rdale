			...
			<thead>
                ...
                <th><input type="checkbox" id="all-checkbox" name="all-checkbox" autocomplete="off"></th>
                    ...
                    <th><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'name/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Name</a></th>
                      ...
                      <th ><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'email/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Email</a></th>
                      <th class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'phone/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Phone</a></th>
                      
                     <th class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'regdate/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Registration Date / Time</a></th>
                     <th><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'status/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Status</a></th> 
                     <th>Details</th>
            ...
            <?php
              ...
              <tr id="<?php echo $this->controller.'-'.$c[$this->pKey];?>">
                 ...
                 <td class="hideCol"><?php echo $c[$this->pKey];?></td>
                  ...
                  <td><?php echo $c[$this->colPrefix.'name'];?></td>
                  <td ><?php echo $c[$this->colPrefix.'email'];?></td>
                   <td class="hideCol"><?php echo $c[$this->colPrefix.'phone'];?></td>
                   
                  
                  <td class="hideCol"><?php echo date('M d, Y h:i a', strtotime($c[$this->colPrefix.'regdate']));?></td>
