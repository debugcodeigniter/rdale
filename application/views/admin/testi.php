...
<div class="row" style="min-height:400px;">
	<div class="col-md-12">
        ...
        <button  class="btn btn-default btn-icon icon-left" type="button" onclick="javascript:window.location='<?php echo base_url();?>manage/<?php echo $this->controller;?>/control'">
		...
		<table id="table-<?php echo $this->controller;?>" class="table table-hover table-striped">
			<thead>
				<tr>
                    ...
                    <th  class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->pKey.'/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">ID</a></th>
					<th ><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'image/'.'/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Image</a></th>
                    <th><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'name/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Name</a></th>
                    <th class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'rating/'.'/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Rating</a></th>
                    <th><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->tStatus.'/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Status</a></th>
                    <th class="hideCol"><a href="<?php echo base_url('manage/'.$this->controller.'/index/'.$this->colPrefix.'added/'.$order.'/'.$status.'/'.$keywords.'/'.$page_numb);?>">Added On</a></th>
                    <th>Actions</th>
				</tr>
			</thead>
            ...
            <?php
              ...
              <tr id="<?php echo $this->controller.'-'.$c[$this->pKey];?>">
                 ...
                 <td >
                  ...
                  <td class="hideCol"><?php for($i=1;$i<=(int)$c[$this->colPrefix.'rating'];$i++)
				  {
					  echo '<i class="entypo-star trating"></i>';
				  }
				  $rem = 5- (int) $c[$this->colPrefix.'rating'];
				  if($rem>0)
				  {
					for($i=1;$i<=$rem;$i++)
					{
						 echo '<i class="entypo-star trating gray"></i>';
					}
				  }
				  ?></td>
			 ...
			 <?php		
				...
				<tr><td colspan="8">Sorry! No Records Found.</td></tr>
              <?php  
			  }
			  ?>
